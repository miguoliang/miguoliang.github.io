+++ 
draft = false
date = 2022-03-26T14:17:45+08:00
...
2. Login to PostgreSQL
   ...
   ![Login to PostgreSQL](screenshot-1.jpg)
...
4. Enter the database name, and save
   ...
   ![Enter the database name](screenshot-3.jpg)

## Create a simple table and insert a record into it

1. Open SQL command window.

   ![Open SQL Command window](screenshot-4.jpg)

2. Paste and run the following codes:
...
![Verify the restored database](screenshot-5.jpg)
