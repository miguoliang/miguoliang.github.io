+++ 
draft = false
date = 2022-03-26T13:53:37+08:00
...
* Login to your [AWS](https://aws.amazon.com/) console.
  ...
  ![Login to your AWS](step-1-1.jpg)

* Open your Lambda console

  ![Open your Lambda console](step-1-2.jpg)

* Create a function

    * Select *Author from scratch*

      ![Select Author from scratch](step-1-3.jpg)

    * Enter *Function name*, we type *function* here

      ![Enter Function Name](step-1-4.jpg)

    * Select *Python 3.7* in *Runtime*

      ![Select Python in Runtime](step-1-5.jpg)

    * Press *Create function*

      ![Press Create function](step-1-6.jpg)

    * Change `Handler` to **function.my_handler**

      ![Change Handler](step-1-7.jpg)

    * Press *Add trigger*

      ![Press Add Trigger](step-1-8.jpg)

    * Select *API Gateway* in *Trigger configuration*

      ![Select API Gateway](step-1-9.jpg)

    * Select *Create a new API* in *API*

      ![Select Create a new API](step-1-10.jpg)

    * Press *Add*

      ![Press Add](step-1-11.jpg)
...
![Setup Environment Variables](step-2.jpg)
...
![Open Audience List](step-12.jpg)
