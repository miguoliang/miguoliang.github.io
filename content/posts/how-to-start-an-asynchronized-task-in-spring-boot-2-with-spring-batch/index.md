+++ 
draft = false
date = 2022-03-26T14:43:57+08:00
...
Spring Batch depends on a relationship database, we use H2 database here. What we need to do is only override the **dataSource** bean in the class.
...
A job is a collection of steps in Spring Batch. We add a job bean and ![img.png](img.png)two-step beans in **BatchConfig** we just created.
